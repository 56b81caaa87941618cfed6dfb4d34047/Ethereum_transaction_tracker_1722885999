...
*/
Vue.component("simple_cta_component_1722886002", {
    template: `
    <section id="cta-component" style="min-height: 150px" class="bg-gray-50 dark:bg-gray-800 flex-1">
        <div id="cta-inner-container" class="max-w-screen-xl px-4 py-8 mx-auto lg:py-16 lg:px-6">
            <div id="cta-content" class="max-w-screen-sm mx-auto text-center">
                ...
                <div id="cta-subtitle-container" class="flex">
                    <p id="cta-subtitle" class="flex-1 mb-6 font-light text-gray-500 dark:text-gray-400 md:text-lg">Stay on top of the latest Ethereum activity with our powerful transaction tracking app</p>
                </div>
